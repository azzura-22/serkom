            ...
            <nav class="col-md-2 sidebar d-md-block" id="sidebar">
                ...
                <ul class="navbar-nav me-auto">
                    <li class="nav-item d-flex align-items-center">
                        <a href="{{route('operator')}}" class="nav-link d-flex align-items-center">
                            <i class="fas fa-home me-2"></i> Dashboard
                        </a>
                    </li>
                    <li class="nav-item d-flex align-items-center">
                        <a href="{{route('operator.user')}}" class="nav-link d-flex align-items-center">
                            <i class="fas fa-users me-2"></i> Daftar user
                        </a>
                    </li>
                    <li class="nav-item d-flex align-items-center">
                        <a href="{{route('operator.siswa')}}" class="nav-link d-flex align-items-center">
                            <i class="fas fa-users me-2"></i> Daftar siswa
                        </a>
                    </li>
                    <li class="nav-item d-flex align-items-center">
                        <a href="{{route('operator.guru')}}" class="nav-link d-flex align-items-center">
                            <i class="fas fa-users me-2"></i> Daftar guru
                        </a>
                    </li>
                    <li class="nav-item d-flex align-items-center">
                        <a href="{{route('operator.galeri')}}" class="nav-link d-flex align-items-center">
                            <i class="fa-solid fa-image me-2"></i> Galery
                        </a>
                    </li>
                    <li class="nav-item d-flex align-items-center">
                        <a href="{{route('operator.berita')}}" class="nav-link d-flex align-items-center">
                            <i class="fa-solid fa-file me-2"></i> Berita
                        </a>
                    </li>
                    <li class="nav-item d-flex align-items-center">
                        <a href="{{route('operator.ekstrakulikuler')}}" class="nav-link d-flex align-items-center">
                            <i class="fa-solid fa-face-smile me-2"></i> Extrakulikuler
                        </a>
                    </li>
                    <li class="nav-item d-flex align-items-center">
                        <a href="{{route('operator.profile')}}" class="nav-link d-flex align-items-center">
